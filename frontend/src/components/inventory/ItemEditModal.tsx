...
function CategoryCombobox({
  ...
  // Fetch distinct categories from existing items
  ...
  // Show "create" option when typed value not in list
            ...
            {filtered.map((cat) => (
              <button
                ...
                className={cn(
                  ...
                  cat === value ? 'bg-accent-sage/10 text-accent-sage font-medium' : 'hover:bg-kraft-50 text-kraft-700'
                )}
              >
                {cat}
              </button>
